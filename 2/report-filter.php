...
$queryangkutan = mysqli_query ($konek, "SELECT noken, po, supir, kp, tgl, DATE_FORMAT(uji, '%d-%m-%Y')as uji, naik, turun, kel FROM angkutan WHERE tgl BETWEEN '$cetak' ORDER BY tgl DESC");
