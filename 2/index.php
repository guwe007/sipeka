          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h1>
                  <center><b>APLIKASI SISTEM INFORMAS PELAPORAN KENDARAAN <p>(ASIN PEDA) <p>OTOBUS</b></center>
                </h1>
                <h3>
                  <center><b>Dinas Perhubungan Kabupaten Cianjur</b></center>
                </h3>
                <center><img src="../aset/foto/sugih.jpg" width="225" height="225" /><img src="../aset/foto/dishub.jpg"
                    width="225" height="225" /></center>
                <h3>
                  <center><b>UPTD Terminal Pasirhayam</b></center>
                </h3>
              </div><!-- /.box-header -->
            </div><!-- /.box -->
          </div><!-- /.col -->
