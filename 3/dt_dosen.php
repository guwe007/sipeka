				<thead>
					<tr>
						...
						<th><center>Perusahaan PO</th></center>
						<!--th><center>Nama Supir</th></center-->
						<th><center>Kartu Pengawas</th></center>
						<th><center>Masa Berlaku Uji</th></center>
						<!--th><center>Penumapang Naik</th></center>
						<th><center>Penumpang Turun</th></center-->
						<th><center>Jumlah Penumpang</th></center>
						...
						while ($angkutan = mysqli_fetch_array ($queryangkutan)){
							...
							echo "
								<tr><center>
									...
									<td>
										<center><a href='lihat.php?noken=$angkutan[noken]'>Lihat Detail</a>
