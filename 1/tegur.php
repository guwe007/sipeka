...
$pdf->Image('../aset/foto/sugih.jpg',9,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(21,0.5,'DINAS PERHUBUNGAN CIANJUR',0,'C');
$pdf->SetX(4);
$pdf->MultiCell(21,0.5,'Telepon : (0263) 263424',0,'C');    
...
$pdf->Cell(25.5,0.7,"SURAT TEGURAN",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
