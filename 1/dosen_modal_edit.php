							...
							<div class="form-group">
								<label>No Kendaraan</label>
									<div class="input-group">
										...
										<input name="id" type="hidden" class="form-control" value="<?php echo $angkutan["id"]; ?>"/>
										<input name="noken" type="text" class="form-control" value="<?php echo $angkutan["noken"]; ?>" />
									</div>
							</div>
							<!--div class="form-group">
							...
							<div class="form-group">
								<label>No. uji</label>
									<div class="input-group">
										...
										<input name="uji" type="text" class="form-control" value="<?php echo $angkutan["uji"]; ?>" >
									</div>
							</div>
							<div class="form-group">
								<label>Masa Berlaku KP</label>
									<div class="input-group date">
										...
										<input id="kp2" name="kp" type="text" class="form-control" value="<?php echo $angkutan["kp"]; ?>">
									</div>
							</div>

							<div class="form-group">
								<label>Tanggal Kendaraan Keluar</label>
									<div class="input-group date">
										<div class="input-group-addon">
											<i class="fa fa-calendar"></i>
										</div>
										<input id="keluar2" name="keluar" type="text" class="form-control" value="<?php echo $angkutan["keluar"]; ?>">
									</div>
							</div>
